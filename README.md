Innovatech Chile – Migración a AWS

infraestructura como código para desplegar una arquitectura segura y escalable en Amazon Web Services (AWS) utilizando Terraform. El proyecto corresponde a la defensa académica de la asignatura de Ingeniería Informática y busca implementar una solución modular y reproducible.
Arquitectura:
...
SG-Data: Solo tráfico desde Back en puerto 3306.
